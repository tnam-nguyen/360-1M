...
The URLS for the filtered subset which is around 5 TB in size can be found here [Metadata with Video URLs](https://huggingface.co/datasets/mwallingford/360-1M/blob/main/Filtered_24k.parquet)
